...
bool testPrecomputedBfacf3Probs(){
	...
	for (int n = 4; n < MAX_PRECOMPUTE_LENGTH; n += 2){
...
/*
4 1 0.2
0.03571428571428572 0.8928571428571428 0.46428571428571425
4 1 0.2135
0.04009886106997887 0.8797034167900635 0.45990113893002116
4 2 0.2
0.05084745762711865 0.8064516129032259 0.42864953526517224
4 2 0.2135
0.05673573412443012 0.7852415422615034 0.4209886381929668
100 1 0.2
0.03571428571428572 0.8928571428571428 0.46428571428571425
100 1 0.2135
0.04009886106997887 0.8797034167900635 0.45990113893002116
100 2 0.2
0.03635067712045617 0.8909090909090909 0.4636298840147735
100 2 0.2135
0.04080266985598808 0.877549005627283 0.45917583774163556
*/

   knot.init_Q(0.2, 1);
   ASSERT_DOUBLES_EQUAL(knot.probMap[4].p_plus2, 0.03571428571428572, EPSILON);
   ASSERT_DOUBLES_EQUAL(knot.probMap[4].p_minus2, 0.8928571428571428, EPSILON);
   ASSERT_DOUBLES_EQUAL(knot.probMap[4].p_0, 0.46428571428571425, EPSILON);
   knot.init_Q(0.2135, 1);
   ASSERT_DOUBLES_EQUAL(knot.probMap[4].p_plus2, 0.04009886106997887, EPSILON);
   ASSERT_DOUBLES_EQUAL(knot.probMap[4].p_minus2, 0.8797034167900635, EPSILON);
   ASSERT_DOUBLES_EQUAL(knot.probMap[4].p_0, 0.45990113893002116, EPSILON);
   knot.init_Q(0.2, 2);
   ASSERT_DOUBLES_EQUAL(knot.probMap[4].p_plus2, 0.05084745762711865, EPSILON);
   ASSERT_DOUBLES_EQUAL(knot.probMap[4].p_minus2, 0.8064516129032259, EPSILON);
   ASSERT_DOUBLES_EQUAL(knot.probMap[4].p_0, 0.42864953526517224, EPSILON);
   knot.init_Q(0.2135, 2);
   ASSERT_DOUBLES_EQUAL(knot.probMap[4].p_plus2, 0.05673573412443012, EPSILON);
   ASSERT_DOUBLES_EQUAL(knot.probMap[4].p_minus2, 0.7852415422615034, EPSILON);
   ASSERT_DOUBLES_EQUAL(knot.probMap[4].p_0, 0.4209886381929668, EPSILON);
   knot.init_Q(0.2, 1);
   ASSERT_DOUBLES_EQUAL(knot.probMap[100].p_plus2, 0.03571428571428572, EPSILON);
   ASSERT_DOUBLES_EQUAL(knot.probMap[100].p_minus2, 0.8928571428571428, EPSILON);
   ASSERT_DOUBLES_EQUAL(knot.probMap[100].p_0, 0.46428571428571425, EPSILON);
   knot.init_Q(0.2135, 1);
   ASSERT_DOUBLES_EQUAL(knot.probMap[100].p_plus2, 0.04009886106997887, EPSILON);
   ASSERT_DOUBLES_EQUAL(knot.probMap[100].p_minus2, 0.8797034167900635, EPSILON);
   ASSERT_DOUBLES_EQUAL(knot.probMap[100].p_0, 0.45990113893002116, EPSILON);
   knot.init_Q(0.2, 2);
   ASSERT_DOUBLES_EQUAL(knot.probMap[100].p_plus2, 0.03635067712045617, EPSILON);
   ASSERT_DOUBLES_EQUAL(knot.probMap[100].p_minus2, 0.8909090909090909, EPSILON);
   ASSERT_DOUBLES_EQUAL(knot.probMap[100].p_0, 0.4636298840147735, EPSILON);
   knot.init_Q(0.2135, 2);
   ASSERT_DOUBLES_EQUAL(knot.probMap[100].p_plus2, 0.04080266985598808, EPSILON);
   ASSERT_DOUBLES_EQUAL(knot.probMap[100].p_minus2, 0.877549005627283, EPSILON);
   ASSERT_DOUBLES_EQUAL(knot.probMap[100].p_0, 0.45917583774163556, EPSILON);
